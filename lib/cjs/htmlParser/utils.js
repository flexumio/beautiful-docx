...
exports.getUUID = exports.hasSpacesAtEnd = exports.hasSpacesAtStart = exports.parseSizeValue = exports.parsePaddingsMergedValue = exports.parsePaddings = exports.getPageWidth = exports.isListTag = exports.getIndent = exports.cleanTextContent = exports.parseTextAlignment = exports.convertPointsToTwip = exports.convertMillimetersToEmu = exports.convertEmuToMillimeters = exports.convertTwipToPixels = exports.convertPixelsToTwip = exports.convertPointsToPixels = exports.convertPixelsToPoints = exports.parseStyles = exports.getAttributeMap = exports.PIXELS_TO_POINT_RATIO = exports.FIRST_LINE_INDENT_MILLIMETERS = void 0;
...
const convertEmuToMillimeters = (emu) => {
    return Math.floor(emu / 36000);
};
exports.convertEmuToMillimeters = convertEmuToMillimeters;
const convertMillimetersToEmu = (millimeters) => {
    return Math.floor(millimeters * 36000);
};
exports.convertMillimetersToEmu = convertMillimetersToEmu;
