...
class TableCreator {
    constructor(element, exportOptions) {
        ...
        this.createRows();
        const beforeTableContent = this.caption ? this.caption : [new TextBlock_1.TextBlock({ children: [] }, [], exportOptions)];
        this.content = [...beforeTableContent, this, new TextBlock_1.TextBlock({ children: [] }, [], exportOptions)];
        this.options = {
