...
class Cell {
    constructor(element, exportOptions, isHeader, cellWidth) {
    ...
    transformToDocx() {
        return [
            new docx_1.TableCell(Object.assign(Object.assign({}, this.options), { children: this.children })),
        ];
    }
    get children() {
    ...
    get tableCellChildren() {
        return new HtmlParser_1.HtmlParser(this.exportOptions, this.containerWidth).parseHtmlTree(this.element.children);
    }
    get cellShading() {
