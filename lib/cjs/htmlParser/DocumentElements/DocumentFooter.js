...
class DocumentFooter {
    constructor(exportOptions) {
        if (!exportOptions.page.numbering) {
            ...
            this.children = new TextBlock_1.TextBlock({ alignment: exportOptions.page.numbering.align }, new TextInline_1.TextInline({ type: 'text', content: 'Number' }, { children: [docx_1.PageNumber.CURRENT] }).getContent()).getContent();
        }
    }
    transformToDocx() {
