...
const TextInline_1 = require("./DocumentElements/TextInline");
...
class TextInlineNormalizer {
    ...
    isInline(child) {
        return child instanceof TextInline_1.TextInline;
    }
    getTextContentRefFromChild(child) {
        ...
        if (currentItemContent instanceof TextInline_1.TextInline) {
